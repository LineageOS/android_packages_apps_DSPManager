...
public class EqualizerSurface extends SurfaceView {
	...
	protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
		...
		mFrequencyResponseBg.setShader(new LinearGradient(0, 0, 0, mHeight,
				 ...
				 * holo_blue_dark < 3
				 */
				new int[] { getResources().getColor(R.color.eq_red),
							 getResources().getColor(R.color.eq_yellow),
							 getResources().getColor(R.color.eq_holo_bright),
							 getResources().getColor(R.color.eq_holo_blue),
							 getResources().getColor(R.color.eq_holo_dark) },
				new float[] { 0, 0.2f, 0.45f, 0.6f, 1f },
				Shader.TileMode.CLAMP));
		mControlBar.setShader(new LinearGradient(0, 0, 0, mHeight,
				new int[] { getResources().getColor(R.color.cb_shader),
							 getResources().getColor(R.color.cb_shader_alpha) },
				new float[] { 0, 1 },
				Shader.TileMode.CLAMP));
	}
